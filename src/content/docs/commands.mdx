...
- [Debian | Debian 源帮助文档 | Tencent Cloud](https://mirrors.cloud.tencent.com/help/debian.html)
- [Debian | MirrorZ Help](https://help.mirrorz.org/debian/)
...
sudo apt update
sudo apt ugrade
sudo apt install wget curl python3-venv tmux htop vim nano -y
```
